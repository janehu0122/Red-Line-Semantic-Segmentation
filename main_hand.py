...
input_dir = "Red Line Data Files/New Images"
target_dir = "Red Line Data Files/New Labels"
img_size = (256, 256)
num_classes = 2
batch_size = 10
epochs = 250
...
# for visualizing on testing images:
testing_dir = "Testing Images - Hand"
...
### for visualizing on training images:
##testing_dir = "Training Images - Hand"
##prediction_generator.generate_predictions_on_folder(folder_path, unet, img_size)
